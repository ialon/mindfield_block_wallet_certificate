...
$data['description'] = 'Rigger Certifier';
$data['serialNumber'] = 'RC-12345';

// Certificate and Crane Type
$data['generic']['secondaryFields'][] = [
    'key' => 'certficateDetails',
    'label' => 'Rigger Certifier',
